...
as well as various patches throughout the game. Two things are changed primarily. 
...
2. Quick deaths are now a thing. Dying will instantly start you over, instead of playing that slow death animation. Start select to exit the current level has been enabled all the time.
